...
public class PaymillDialog extends Dialog {
	
	private static String TAG = "PaymillDialog";
	...
	public PaymillDialog(Context context, String url, String callbackUrl, OAuthDialogListener listener) {
		super(context);
		mUrl = url;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PaymillUtils.removeAllCookies(getContext());
	}

	private void setUpTitle() {
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		mTitle = new TextView(getContext());
		mTitle.setText("Paymill Connect");
